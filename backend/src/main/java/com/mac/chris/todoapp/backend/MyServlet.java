...
package com.mac.chris.todoapp.backend;
...
public class MyServlet extends HttpServlet {
    static Logger Log = Logger.getLogger("com.mac.chris.todoapp.backend.MyServlet");
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        Firebase firebase = new Firebase("https://todoapp1982.firebaseio.com/todoItems");
        firebase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    msg.setFrom(new InternetAddress("nagger@[todo-list-1260].appspotmail.com",
                            "Todo Nagger"));
                    msg.addRecipient(Message.RecipientType.TO,
                            new InternetAddress("cwryder82@gmail.com", "Recipient"));
